...
namespace JboxWebdav.WpfApp.Services
{
    public class WebdavHttpListener
    {
        ...
        private static ILog s_log = LogManager.GetLogger(typeof(WebdavHttpListener));

        private static async void DispatchHttpRequestsAsync()
        {
        ...
        private static async void GetContextCallBack(IAsyncResult ar)
        {
            ...
            {
                s_log.Fatal("DispatchRequest失败", ex);
